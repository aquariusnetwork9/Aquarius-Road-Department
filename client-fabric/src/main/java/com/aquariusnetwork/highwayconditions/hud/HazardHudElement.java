 ...
 * toggled off.
 *
 * <p>Registered against {@code HudElementRegistry} (see the entrypoint) -- this class itself
 * just exposes a plain {@link #render} method matching {@code HudElement}'s functional shape,
 * the same signature the older, now-superseded {@code HudRenderCallback} used.
 *
