...
public final class HighwayConditionsFabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        // NEXT rename, to HudElementRegistry/HudElement, doesn't land until MC 1.21.6). Attached
        // just before vanilla chat so it inherits chat's own render-visibility condition (e.g. a
        // hidden HUD).
